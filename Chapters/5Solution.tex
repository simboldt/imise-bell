...
Die Audiodateien werden einzeln transkribiert, weil sonst die RAM Kapazität überschritten wird, was zu Abstürzen führt.
Dabei Belegung der Parameter erfolgt dabei wie in \cref{tab:transkription_einstellungen} gezeigt ist.
...
Als Beispiel wurde das Transkript der Vorlesung zum dritten Kapitel (Information System Basics) ausgewählt.
...
Dieses Kapitel eignet sich auch inhaltlich gut, da es noch eher grundlegende Themen behandelt, was das Korrigieren des Textes erleichtert.
