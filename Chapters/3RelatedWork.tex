...
\subsection{Whisper}
Whisper ist ein Open-Source-Transkriptionsmodell von OpenAI, welches mit 680.000 Stunden an Audio in verschiedenen Sprachen aus dem Internet trainiert wurde.
