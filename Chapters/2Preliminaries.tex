...
Zwischen den Neuronen existieren gewichtete Verbindungen. %(Abb. noch einfügen) Shiruru, Kuldeep in thesis.bib
...
Danach werden alle dieser Produkte summiert und durch eine weitere sogenannte Aktivierungsfunktion verändert.
