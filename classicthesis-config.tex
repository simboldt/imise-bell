...
% ****************************************************************************************************
\newcommand{\myTitle}{Transkription von Vorlesungsaufnahmen für Question Answering im Bereich Medizinische Informatik mittels grosser generativer Sprachmodelle\xspace}
\newcommand{\mySubtitle}{Facharbeit Simon Boldt\xspace}
...
\newcommand{\myProf}{Robert Karl\xspace}
...
\newcommand{\mySubject}{Informatik\xspace}
...
\newcommand{\myTime}{19. Dezember 2025\xspace}
...
\counterwithout{figure}{chapter} % Optional: also for figures
